...
import { urbanLegacy, akuRuo, eastView, koleAyo, obiEze, eliteCity, eliteCasa, alaomaLuxury, eliteEmpire, greenView, ugochiEstate, yearsOfExp } from "@/features/assets";
        ...
        <div className="flex flex-col lg:flex-row items-center w-full gap-8 md:gap-12">
          ...
          <div className="w-full lg:w-1/2 flex flex-col text-center lg:text-left items-center lg:items-start pt-4 lg:pt-0">
            <div className="flex flex-col gap-4 mb-6">
              <span className="text-xl font-medium text-gray-700">{currentId} — 11</span>
              <div>
